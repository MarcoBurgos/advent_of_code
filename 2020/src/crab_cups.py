...
if __name__ == "__main__":
    file_location = r"inputs/day23.txt"
    print(f"Solution 1: {crab_cups_1(file_location)}")
    print(f"Solution 2: {crab_cups_2(file_location)}")
